...
const Header = () => {
  ...
  return (
    <div ref={containerRef} className="h-full">
      {/* INTRO LAYERS */}
      <div ref={introBgRef} id="intro-bg" className="fixed inset-0 bg-black z-40" />
      <div ref={introContainerRef} id="intro-container" className="fixed inset-0 z-50 flex justify-center items-center pointer-events-none">
