...
const initialSkills = [
  ...
  { id: "pandas", name: "Pandas", icon: <SiPandas />, color: "#150458", bx: 30, by: -15, group: "ai", connections: ["python", "numpy"] }, // Pandas Navy
  ...
  // --- BOTTOM ROW ---
  { id: "k8s", name: "K8s", icon: <SiKubernetes />, color: "#326CE5", bx: -25, by: 30, group: "cloud", connections: ["docker", "terraform"] }, // K8s Blue
